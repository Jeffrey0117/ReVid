...
const translations = {
  en: {
    ...
    lastWatchedTime: 'Last watched: {time}',
    ...
    loginRequired: 'Login may be required',
    loginHint: 'Please log in below, then the video will be detected automatically',
    autoNavigating: 'Auto-navigating to video...',
    ...
    templateHint: 'Variables: {n}=number, {title}=original title, {i}=index',
    ...
    pasteNamesPlaceholder: 'Episode 1\nEpisode 2\nEpisode 3\n...',
    pasteHint: '{total} courses, {entered} lines entered',
    delete: 'Delete',
    playlist: 'Playlist',
  ...
  'zh-TW': {
    ...
    loginRequired: '可能需要登入',
    loginHint: '請先登入，登入後會自動偵測影片',
    autoNavigating: '自動導航至影片中...',
    ...
    rename: '重新命名',
    nameTemplate: '命名模板',
    templateHint: '可用變數: {n}=編號, {title}=原標題, {i}=序號',
    startNumber: '起始編號',
    preview: '預覽',
    items: '個項目',
    templateMode: '模板模式',
    pasteMode: '貼上模式',
    pasteNames: '貼上名稱（每行一個）',
    pasteNamesPlaceholder: '第一集\n第二集\n第三集\n...',
    pasteHint: '共 {total} 個課程，已輸入 {entered} 行',
    delete: '刪除',
    playlist: '播放列',
    newFolder: '新增資料夾',
    addVideo: '新增',
